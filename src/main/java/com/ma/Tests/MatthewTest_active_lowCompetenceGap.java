 ...
 */
public class MatthewTest_active_lowCompetenceGap extends Test {

    public void run() {
        name = "MatthewTest_active_lowCompetenceGap";
        ...
        c.addUser("average", 1, 0.4, 0,
                0, 0.5, 0.5,
                0.7, 0, 1.0, 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 20);


        c.addUser("top", 1, 0.4, 0,
                0, 0, 0.5,
                0.8, 0, 0, 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 3);
