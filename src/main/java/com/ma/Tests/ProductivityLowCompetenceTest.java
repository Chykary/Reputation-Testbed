 ...
 */
public class ProductivityLowCompetenceTest extends Test {

    public void run() {
        name = "ProductivityLowCompetenceTest";

        ArrayList<LabelColorPair> lcp = new ArrayList<>();

        lcp.add(new LabelColorPair("high", Color.red));
        lcp.add(new LabelColorPair("average", Color.yellow));
        lcp.add(new LabelColorPair("low", Color.green));
        ...
        c.addUser("low", 1, 0.2, 0,
                0, 0, 0.5,
                0.1, 0, 0, 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 10);

        c.addUser("average", 1, 0.5, 0,
                0, 0, 0.5,
                0.1, 0, 0, 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 10);


        c.addUser("high", 1, 0.8, 0,
                0, 0, 0.5,
                0.1, 0, 0, 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 10);
